...
export interface Opportunity {
  ...
  imageUrl: string;
  description: string;
  recommended?: boolean; // Highly recommended events
}
...
export const opportunities: Opportunity[] = [
  {
    id: "opp-001",
    title: "Huckleberry Trail Cleanup",
    org: "org-green-city",
    ...
    description:
      "Join us for a morning trail cleanup along the Huckleberry Trail. We'll remove invasive plants, pick up litter, and restore native habitat. Gloves and bags provided — just bring water and sturdy shoes.",
    recommended: true,
  },
  {
    id: "opp-002",
    ...
    location: "Blacksburg Community Garden, Blacksburg, VA",
    spotsTotal: 15,
    spotsFilled: 7,
    xpReward: 80,
  ...
  },
  {
    ...
    location: "Montgomery County Food Pantry, Christiansburg, VA",
    spotsTotal: 12,
    spotsFilled: 12,
    xpReward: 60,
  ...
  },
  {
    ...
    location: "Various Neighborhoods, Blacksburg, VA",
    spotsTotal: 8,
    spotsFilled: 3,
    xpReward: 90,
  ...
  },
  {
    ...
    location: "Blacksburg Middle School, Blacksburg, VA",
    spotsTotal: 10,
    spotsFilled: 6,
    xpReward: 70,
  ...
  },
  {
    ...
    location: "Montgomery-Floyd Regional Library, Christiansburg, VA",
    spotsTotal: 16,
    spotsFilled: 9,
    xpReward: 65,
  ...
  },
  {
    ...
    location: "Montgomery County Animal Shelter, Christiansburg, VA",
    spotsTotal: 10,
    spotsFilled: 4,
    xpReward: 55,
  ...
  },
  {
    ...
    location: "Virginia Tech Drillfield, Blacksburg, VA",
    spotsTotal: 25,
    spotsFilled: 18,
    xpReward: 100,
  ...
  },
  {
    ...
    location: "Heritage Park, Blacksburg, VA",
    spotsTotal: 50,
    spotsFilled: 31,
    xpReward: 85,
  ...
  {
    id: "opp-011",
    title: "Downtown Mural Painting",
    org: "org-civic-builders",
    category: "Community",
    date: "2025-08-17T10:00:00.000Z",
    location: "Downtown Blacksburg, Blacksburg, VA",
    spotsTotal: 18,
    spotsFilled: 11,
    xpReward: 95,
    imageUrl: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&h=400&fit=crop",
    description:
      "Help paint a community mural celebrating Blacksburg's cultural diversity. No art experience required — our lead artist will direct the project. Wear clothes you don't mind getting paint on!",
  },
  {
    id: "opp-012",
    ...
    location: "Main Street, Christiansburg, VA",
    spotsTotal: 14,
    spotsFilled: 5,
    xpReward: 70,
    imageUrl: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&h=400&fit=crop",
    description:
      "Remove graffiti and beautify storefronts in downtown Christiansburg. Supplies provided. This is a great way to make a visible difference in your community in just a few hours.",
  },
];
...
export const groups: Group[] = [
  ...
  {
    id: "group-003",
    name: "New River Valley Volunteers",
    city: "Blacksburg, VA",
    memberCount: 31,
    aggregateXp: 24600,
  },
